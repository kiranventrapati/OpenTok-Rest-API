...
public class ResponseStatus {
	...
	public static enum Status {
		OK,
		/* Auth Failures */
		INVALID_CREDENTIALS, LOGIN_FAILED, ACCESS_DENIED, ACCOUNT_LOCKED, ACCOUNT_CLOSED, EMAIL_NOT_REGISTERED, // break
		INVALID_API_KEY, INVALID_AUTH_TOKEN, FB_LOGIN_FAILED, FB_USER_NOT_FOUND, EMAIL_UNAVAILABLE, FB_USER_EXISTS, INVALID_MEMBER,
		/* Validation Failure */
		FAIL, CROSS_SITE_SCRIPT_ERROR, ANOTHER_SITTER_BOOKED, NO_BOOST_SLOT_AVAILABLE, NO_SLOT_AVAILABLE,
		/* Error */
		ERROR, UNKNOWN_ERROR, PAYMENT_GENERIC_ERROR, CREDIT_CARD_INVALID, CREDIT_CARD_TYPE_INVALID, CREDIT_CARD_INACTIVE, PAYMENT_SERVICE_UNAVAILABLE, MUST_UPGRADE, PREFER_UPGRADE, INVALID_OS, BACKGROUND_CHECK_REPORT_INACTIVE_EXPIRED, UNDERAGE_FEATURE_UNAVAILABLE, SOCIAL_GRAPH_NOT_BUILT_ERROR, FACEBOOK_NOT_CONNECTED, INVALID_STATE, VIDEO_CALL_DISABLED, RECEIVER_NOT_OPTED_IN_FOR_VIDEO_CALL,
		/* BackupCareAPI Validations Failure */
		// Stripe
		STRIPE_EXCEPTION, BACKUPCARE_COMMENT_SIZE, INVALID_BOOKING, BUC_INVALID_PARTNERKEY, INVALID_SITE, INSUFFICIENT_CREDITS, GOOGLE_CRCM_LOGIN_NEEDED;
	}
	...
	static {
		...
		statusMap.put(Status.NO_BOOST_SLOT_AVAILABLE, 1405);
		statusMap.put(Status.NO_SLOT_AVAILABLE, 1406);
		...
		/* Stripe Exception : 1601 */
		statusMap.put(Status.STRIPE_EXCEPTION, 1601);
